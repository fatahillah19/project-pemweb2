...
<head>
    ...
    <style>
        ...
        .siakad-blog-header {
            border-color: #d9e8e4;
            box-shadow: 0 10px 28px rgba(40, 74, 70, .08);
        }
        ...
        .siakad-blog-brand strong,
        .siakad-blog-brand small {
            display: block;
        }
            ...
            <div class="container mx-auto">
                ...
                <div class="mt-7 flex flex-wrap items-start justify-center gap-10 border-t border-slate-200 pt-5">
                    <div class="text-hurricane/50 text-sm font-medium">
                        © {{ now()->year }} SMA NURUL FIKRI. {{__('filament-blog::blog-views.layout.footer.copyright')}}
                    </div>
                </div>
            </div>
        </footer>
